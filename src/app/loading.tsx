export default function Loading() {
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center px-6 bg-linear-to-br from-orange-50 via-white to-orange-50/30">
            <div className="flex flex-col items-center gap-8">
                {/* Animated Logo */}
                <div className="relative">
                    <div className="absolute inset-0 bg-orange-400/20 rounded-full blur-xl animate-pulse" />
                    <div className="relative flex items-center gap-3">
                        <div className="w-12 h-12 bg-linear-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/30 animate-bounce">
                        ...
                        <span className="text-3xl font-bold bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                            Event<span className="text-orange-600">o</span>ra
                        </span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 mt-4">
                    ...
                    <p className="text-sm font-medium text-gray-500">Preparing your experience...</p>
                </div>
            </div>
        </div>
    );
