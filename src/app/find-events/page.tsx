...
export default function EventDiscoveryPage() {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- geolocation callback is an external system
        ...
        mobileFiltersOpen && (
            <div className="fixed inset-0 z-50 lg:hidden">
                ...
                <div className="absolute top-0 left-0 bottom-0 w-80 max-w-[85vw] bg-white shadow-xl overflow-y-auto">
                    ...
                    <div className="p-5">
                        <Sidebar className="!block !sticky !top-0 !max-h-none !pr-0" selectedCategories={selectedCategories} onCategoryChange={(cats) => { handleCategoryChange(cats); setMobileFiltersOpen(false); }} />
                    </div>
                </div>
            </div>
        )
