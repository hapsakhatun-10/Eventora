...
const socialLinks = [
    { name: "X", href: "https://x.com/eventora", icon: XIcon },
    { name: "Facebook", href: "https://facebook.com/eventora", icon: FacebookIcon },
    { name: "LinkedIn", href: "https://linkedin.com/company/eventora", icon: LinkedInIcon },
    { name: "Instagram", href: "https://instagram.com/eventora", icon: InstagramIcon },
    { name: "TikTok", href: "https://tiktok.com/@eventora", icon: TikTokIcon },
];
        ...
        <footer className="bg-slate-900 text-slate-300">
            <div className="mx-auto px-6 sm:px-10 md:px-14 lg:px-18 py-10 sm:py-14">
                ...
                <div className="mb-12 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
                    <Link href="/" className="group flex w-fit items-baseline gap-0.5">
                    ...
                    <div className="flex items-center gap-3">
                        {socialLinks.map(({ name, href, icon: Icon }) => (
                            <a
                                ...
                                className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/10 text-slate-400 transition-all duration-200 hover:bg-white/20 hover:text-white hover:-translate-y-0.5 hover:shadow-lg"
                                title={name}
                            >
