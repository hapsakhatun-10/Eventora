...
const AsideEvent = ({
    ...
    return (
        <>
            {/* Desktop Sidebar */}
            <aside className="hidden lg:flex w-80 shrink-0 sticky top-0 h-screen flex-col border-r border-slate-200 bg-white">
                    ...
                    <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8">
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm font-bold text-slate-900">{Math.round((activeStep / 5) * 100)}%</span>
                            </div>
                            <div className="mt-3 h-2 rounded-full bg-slate-200 overflow-hidden">
                                <div className="h-full rounded-full bg-slate-900 transition-all duration-300" style={{ width: `${(activeStep / 5) * 100}%` }} />
                            </div>
                        </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="text-left">
                                            <h4 className={`font-semibold ${isActive ? "text-slate-900" : "text-slate-800"}`}>
                                                {step.title}
                                            </h4>
            ...
            <div className="lg:hidden w-full bg-white border-b border-slate-200 sticky top-18 z-40">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0">
                                            <h4 className={`text-xs font-semibold ${isActive ? "text-slate-900" : "text-slate-700"}`}>
                                                {step.title}
                                            </h4>
